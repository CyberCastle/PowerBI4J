...
@JsonPropertyOrder({ Gateways.JSON_PROPERTY_ODATA_CONTEXT, Gateways.JSON_PROPERTY_VALUE })
...
public class Gateways {
    ...
    public Gateways odataContext(String odataContext) {
    ...
    public Gateways value(List<Gateway> value) {

        this.value = value;
        return this;
    }

    public Gateways addValueItem(Gateway valueItem) {
        if (this.value == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.odataContext, gateways.odataContext) && Objects.equals(this.value, gateways.value);
    }
