 ...
 */
@ApiModel(description = "Capacity workload setting")
@JsonPropertyOrder({ Workload.JSON_PROPERTY_NAME, Workload.JSON_PROPERTY_STATE,
        Workload.JSON_PROPERTY_MAX_MEMORY_PERCENTAGE_SET_BY_USER })
...
public class Workload {
    ...
    @ApiModelProperty(value = "The workload name")
    ...
    public Workload state(WorkloadState state) {
    ...
    public Workload maxMemoryPercentageSetByUser(Integer maxMemoryPercentageSetByUser) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.name, workload.name) && Objects.equals(this.state, workload.state)
                && Objects.equals(this.maxMemoryPercentageSetByUser, workload.maxMemoryPercentageSetByUser);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, state, maxMemoryPercentageSetByUser);
    }
