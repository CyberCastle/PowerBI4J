...
@JsonPropertyOrder({ Dashboards.JSON_PROPERTY_ODATA_CONTEXT, Dashboards.JSON_PROPERTY_VALUE })
...
public class Dashboards {
    ...
    public Dashboards odataContext(String odataContext) {
    ...
    public Dashboards value(List<Dashboard> value) {

        this.value = value;
        return this;
    }

    public Dashboards addValueItem(Dashboard valueItem) {
        if (this.value == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.odataContext, dashboards.odataContext)
                && Objects.equals(this.value, dashboards.value);
    }
