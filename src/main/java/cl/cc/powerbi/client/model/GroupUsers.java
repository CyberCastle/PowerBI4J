...
@JsonPropertyOrder({ GroupUsers.JSON_PROPERTY_ODATA_CONTEXT, GroupUsers.JSON_PROPERTY_VALUE })
...
public class GroupUsers {
    ...
    private List<GroupUser> value = null;

    public GroupUsers odataContext(String odataContext) {
    ...
    public GroupUsers value(List<GroupUser> value) {

        this.value = value;
        return this;
    }

    public GroupUsers addValueItem(GroupUser valueItem) {
        if (this.value == null) {
    ...
    public List<GroupUser> getValue() {
        return value;
    }

    public void setValue(List<GroupUser> value) {
        this.value = value;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.odataContext, groupUsers.odataContext)
                && Objects.equals(this.value, groupUsers.value);
    }
