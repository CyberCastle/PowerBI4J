...
@JsonPropertyOrder({ Imports.JSON_PROPERTY_ODATA_CONTEXT, Imports.JSON_PROPERTY_VALUE })
...
public class Imports {
    ...
    public Imports odataContext(String odataContext) {
    ...
    public Imports value(List<ModelImport> value) {

        this.value = value;
        return this;
    }

    public Imports addValueItem(ModelImport valueItem) {
        if (this.value == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.odataContext, imports.odataContext) && Objects.equals(this.value, imports.value);
    }
